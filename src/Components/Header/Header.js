      ...
      <div className="row">
         <div className="header_button">
             ...
             <Button variant="success">Connexion 
                <i class="fa fa-user" aria-hidden="true" style={{marginLeft:"4px"}}></i>
            </Button>
        </div>
       </div>
       <div class="row">
            ...
            <InputGroup className="col-sm-5">
                    ...
                    />
                    <InputGroup.Append>
                    <Button variant="outline-success"><i class="fa fa-search" aria-hidden="true" style={{color:"rgb(237,28,36)"}}>
                    </i></Button>
                    </InputGroup.Append>
                </InputGroup>
           </div>
